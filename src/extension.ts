...
import { aksKubectlAIDeploy, aksUpdateKubectlAIResource } from './commands/aksKubectlAI/aksKubectlAI';
...
export async function activate(context: vscode.ExtensionContext) {
    ...
    if (cloudExplorer.available) {
        ...
        registerCommandWithTelemetry('aks.aksUpdateKubectlAIResource', aksUpdateKubectlAIResource);
