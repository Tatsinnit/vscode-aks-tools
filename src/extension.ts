...
import aksCSICreateStorageAccount from './commands/aksCSIDriver/aksCSIDriverStorageClassDeploy';
...
export async function activate(context: vscode.ExtensionContext) {
    ...
    if (cloudExplorer.available) {
        ...
        registerCommandWithTelemetry('aks.aksCSICreateStorageAccount', aksCSICreateStorageAccount);
